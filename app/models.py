...
class History(db.Model):
    ...
    deaily_deposit = db.Column(db.Integer, default = 0)
    ...
    weekly_deposit = db.Column(db.Integer, default = 0)
    ...
    monthly_deposit = db.Column(db.Integer, default = 0)
    ...
    yearly_deposit = db.Column(db.Integer, default = 0)
