...
if __name__ == '__main__':
    ...
    result = engine.execute("INSERT INTO titanbets (tlr_amount, real_clicks, casino_u_real_count, casino_d_rf_count, casino_net_gaming, poker_u_real_count, poker_d_rf_count, poker_net_gaming, sport_u_real_count, sport_d_rf_count) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s);", tuple(data.values()))
